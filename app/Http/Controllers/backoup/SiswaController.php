...
class SiswaController extends Controller
{
    ...
    {
        //
       return view('siswas.create',['id'=> $id ]);
    }
    ...
    public function store(Request $request)
    {
     ...
     $siswa->save();
        ...
        return redirect("/admin/siswas/$request->id");
    }
    ...
    public function show(Request $request, Builder $htmlBuilder, $id)
    {
         if ($request->ajax()) {
            ...
            $siswas = Siswa::with(['kelas'])->where('id' , $id);
...
return view('siswas.index',['id' => $id])->with(compact('html'));
    ...
    public function edit($id)
    {
        ...
        $siswa = Siswa::find($id);
         ...
         return view('siswas.edit',['id'=> $siswa->id,'siswa' => $siswa ]);
    }
