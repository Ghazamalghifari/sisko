...
<div class="md-form{!! $errors->has('id_karyawan') ? 'has-error' : '' !!}">
			<div class="col-md-5">
				{!! Form::select('id_karyawan', [''=>'']+App\Karyawan::pluck('nama_karyawan','id')->all(), null, ['class'=>'mdb-select colorful-select dropdown-primary js-selectize', 'placeholder' => 'Pilih Ibu/Bapak Catering'
				]) !!}
