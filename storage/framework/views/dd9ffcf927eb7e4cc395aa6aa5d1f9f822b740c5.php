<div class="col-md-2">
				...
				<label><b>Ibu/Bapak Catering :</b></label>
</div>
<div class="md-form<?php echo $errors->has('id_karyawan') ? 'has-error' : ''; ?>">
			<div class="col-md-5">
				<?php echo Form::select('id_karyawan', [''=>'']+App\Karyawan::pluck('nama_karyawan','id')->all(), null, ['class'=>'mdb-select colorful-select dropdown-primary js-selectize', 'placeholder' => 'Pilih Ibu/Bapak Catering'
				]); ?>
