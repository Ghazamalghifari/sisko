...
<div class="md-form<?php echo e($errors->has('alamat_ibu') ? ' has-error' : ''); ?>">
    <div class="col-md-6">
		...
		<div class="md-form<?php echo $errors->has('id_angkatan') ? 'has-error' : ''; ?>">
			<?php echo Form::label('id_angkatan', ' ', ['class'=>'col-md-2 control-label']); ?>

			<div class="col-md-6">
				<?php echo Form::select('id_angkatan',[''=>'']+App\Alumni::pluck('angkatan','id')->all(), null, ['class'=>'mdb-select', 'placeholder' => 'Pilih Angkatan']); ?>
		...
		<div class="md-form<?php echo $errors->has('id_kelas') ? 'has-error' : ''; ?>">
			<?php echo Form::label('id_kelas', ' ', ['class'=>'col-md-2 control-label']); ?>

			<div class="col-md-6">
				<?php echo Form::select('id_kelas',[''=>'']+App\Kelas::pluck('kelas','id')->all(), null, ['class'=>'mdb-select', 'placeholder' => 'Pilih Kelas']); ?>
